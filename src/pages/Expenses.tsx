...
import { PROP_FIRMS, EXPENSE_CATEGORIES, Expense } from "@/types";
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div className="space-y-2">
          ...
          <Select
            value={formData.propFirm || "none"}
            onValueChange={(value) => setFormData({ ...formData, propFirm: value === "none" ? undefined : value })}
          >
            <SelectTrigger>
